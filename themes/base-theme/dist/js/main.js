"use strict";
(self["webpackChunkrestruct_base_package_json"] = self["webpackChunkrestruct_base_package_json"] || []).push([["/js/main"],{
...
//
document.querySelector('body').classList.remove('no-js'); // ### jQuery ###
//
...
/******/ __webpack_require__.O(0, ["css/cms","css/editor","css/main","/js/vendor"], () => (__webpack_exec__("./src/js/main.js"), __webpack_exec__("./src/scss/main.scss"), __webpack_exec__("./src/scss/editor.scss"), __webpack_exec__("./src/scss/cms.scss")));
